...
class WeatherProxyPage extends StatefulWidget {
  ...
  const WeatherProxyPage({super.key, this.stations});
...
class _WeatherProxyPageState extends State<WeatherProxyPage> {
  ...
  Stations? _station;                // 👈 estación elegida por el usuario
  ...
  Future<void> _pickStation() async {
    final selected = await showModalBottomSheet<Stations>(
      context: context,
